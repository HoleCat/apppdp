<div class="col-12">
    ...
    <div class="col-12 text-center">
        <h3 class="py-3">MUESTRAS DEL REGISTRO DE VENTAS</h1>
    </div>
    <div class="jumbotron col-12 text-left py-3">
        <h5>1. Importar archivo</h5>
        <form id="formcargaventas" enctype="multipart/form-data">
            ...
            <div class="col-12 d-flex px-0">
                ...
                <div class="col-xs-2 text-center" id="cargaventasfile">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-4 col-sm-12 col-xs-12">
                <form id="formfiltroventas" class="text-center">
                    <input type="hidden" name="iduso" value="{{$uso->id}}">
                    <input type="hidden" id="idarchivoventas" name="id_archivo" value="">
                    <div class="form-group text-left d-flex">
                        <input type="submit" class="btn btn-primary" value="FILTRAR">
                        <div id="cargafiltroventas">
...
<script>
    ...
    seteventview2('/New/new_ventas');
    setview('#form-historico','#nav-muestreo-content','/Old/old_ventas');
</script>