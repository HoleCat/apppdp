...
class CreateValidacionReporteComprasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('validacion_reporte_compras', function (Blueprint $table) {
            $table->id();
            $table->string('Liberar')->nullable();
    ...
    {
        Schema::dropIfExists('validacion_reporte_compras');
    }
}
